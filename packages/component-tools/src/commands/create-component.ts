...
export const createComponentCommand = new Command('create-component')
  ...
  .action(async (name: string, options: {
    ...
    try {
      ...
      console.log(`\n✅ Component created successfully at ${componentDir.componentDir}`);
      console.log('\nNext steps:');
      console.log('1. Implement your component logic');
      console.log('2. Register your component with: component-tools register ' + componentDir.componentDir);
    } catch (error) {
